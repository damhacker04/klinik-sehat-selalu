-- ============================================
-- Klinik Sehat Selalu - Initial Database Schema
-- PRD v3.0 Final - All 7 Service Tables
-- ============================================
...
-- Uses Supabase Auth for core auth, this extends it
-- ============================================
...
CREATE TABLE rekam_medis (
    ...
    id_pasien INT NOT NULL,  -- Ref to Patient Service
...
CREATE TABLE resep (
    ...
    id_rekam INT NOT NULL,  -- Ref to Medical Record Service
    id_dokter INT NOT NULL,  -- Ref to dokter
...
CREATE TABLE transaksi (
    ...
    id_pasien INT NOT NULL,  -- Ref to Patient Service
    id_rekam INT,  -- Ref to Medical Record Service
...
-- ============================================
-- INDEXES (NFR 14.3 - Query optimization)
-- ============================================
...
-- ============================================
-- AUTO-CREATE user_accounts ON AUTH SIGNUP
-- ============================================
...
BEGIN
    ...
    VALUES (
        NEW.id,
        NEW.email,
        COALESCE(NEW.raw_user_meta_data->>'role', 'pasien')::user_role,
        'active'
    );
    RETURN NEW;
END;
